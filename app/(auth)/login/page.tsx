...
function LoginForm() {
  ...
  const onSubmit = async (data: LoginInput) => {
    ...
    // Router.push keeps the old session state — window.location.href does not
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-8 shadow-xl shadow-black/20">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Button type="submit" variant="brand" size="lg" className="w-full mt-2" disabled={isSubmitting}>
          {isSubmitting
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Sign in to your accountant account</p>
        </div>
